...
x1 = np.array([-2, -1.5, 0, 1.0, 2.2, 3.1])  
yi = np.array([-30.5, -20.2 , -3.3, 8.9, 16.8, 21.4])

x2 = np.array([abs(-2**2), abs(-1.5**2), abs(0**2), abs(1.0**2), 2.2**2, 3.1**2])  
x3 = np.array([-2**3, -1.5**3, 0**3, 1.0**3, 2.2**3, 3.1**3])  
x4 = np.array([abs(-2**4), abs(-1.5**4), 0**4, 1.0**4, 2.2**4, 3.1**4])  
